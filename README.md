...
最新版：[PhotoTrail v0.3.5](https://github.com/LittleSixNine/PhotoTrail/releases/tag/v0.3.5)。下载 `PhotoTrail-0.3.5-macOS-universal.zip`，解压后将 `PhotoTrail.app` 拖入“应用程序”。旧版 `v0.1.0`、`v0.2.0` 是早期预览版，仅供历史参考。
